...
// Create post takes a string of content and an optional fileId
...
export const getSignedURL = async ({ fileType, fileSize, checksum }: GetSignedURLParams): SignedURLResponse => {
  const session = await auth()
